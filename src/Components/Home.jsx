    ...
    return(
        <>
            ...
            <div className="absolute inset-0 bg-black imageDegrade min-h-full min-w-full"></div>
                ...
                <button className="bg-white rounded-sm mt-4 w-56 h-10 text-black absolute bottom-1/4 md:bottom-56 md:right-10 cursor-pointer z-20">Descubre mi trabajo</button>
            </section>
